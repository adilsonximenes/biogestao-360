...
1.2 Taxa Metabólica Basal (TMB) - Harris-Benedict

Fórmula para HOMENS:
TMB = 66.47 + (13.75 × Peso) + (5.0 × Altura) - (6.75 × Idade)

Exemplo com dados padrão (Homem, 85.8kg, 164cm, 47 anos):
...
Atleta (2x treino/dia) = 1.9

Exemplo com dados padrão (NAF Moderado = 1.55):
GET = 1.749 × 1.55
GET = 2.711 kcal/dia
...
IMC Ideal de referência:
Homens = 21.7
Mulheres = 21.3

Exemplo com dados padrão (Homem):
Peso Ideal = 21.7 × (1.64 × 1.64)
Peso Ideal = 21.7 × 2.6896
Peso Ideal = 58.4 kg
...
Exemplo com dados padrão (IMC = 31.9, Idade = 47):
% Gordura = (1.20 × 31.9) + (0.23 × 47) - 16.2
% Gordura = 38.28 + 10.81 - 16.2
% Gordura = 32.9%
...
Adipômetro (Plicômetro) = Medir gordura subcutânea → % de gordura corporal (unidade: mm)
Fita Métrica = Medir perímetros musculares e circunferências (unidade: cm)
Handgrip (Dinamômetro) = Avaliar força de preensão palmar (unidade: kg/f)
Banco de Wells = Avaliar flexibilidade (unidade: cm)
...
1. Tríceps (TR) - Face posterior do braço
2. Bíceps (BI) - Face anterior do braço
3. Peitoral (TX) - Metade da distância axila-mamilo
4. Subescapular (SB) - 2cm abaixo do ângulo inferior da escápula
5. Axilar Média (AM) - Intersecção linha axilar média com apêndice xifóide
6. Supra-ilíaca (SI) - Sobre a crista ilíaca, linha axilar média
7. Supra-espinal (SS) - 5-7cm acima da espinha ilíaca anterior
8. Abdominal (AB) - 2cm à direita da cicatriz umbilical
9. Coxa (CX) - Ponto médio entre inguinal e patela
10. Panturrilha (PN) - Maior perímetro da perna

========================================

3.4 Circunferências Padronizadas (Fita Métrica)

1. Braço Contraído - Maior circunferência do braço com contração
2. Peitoral / Tórax - Altura dos mamilos, em expiração normal
3. Cintura - Ponto médio entre costela e crista ilíaca
4. Quadril - Maior circunferência glútea
5. Coxa - Terço proximal da coxa
6. Panturrilha - Maior circunferência da perna
...
| Biotipo | Característica | % Gordura típico |
|---------|----------------|------------------|
| Endomorfo | Tendência a acumular gordura | >25% (H) / >28% (M) |
| Mesomorfo | Estrutura atlética natural | 10-18% (H) / 18-25% (M) |
| Ectomorfo | Metabolismo acelerado | <10% (H) / <18% (M) |
...
- Masculino: Fraco <35 kg | Regular 35-45 kg | Forte >45 kg
- Feminino: Fraco <25 kg | Regular 25-35 kg | Forte >35 kg

Banco de Wells (Flexibilidade):
- Masculino: Abaixo da média <20 cm | Média 20-30 cm | Acima da média >30 cm
- Feminino: Abaixo da média <25 cm | Média 25-35 cm | Acima da média >35 cm
...
Fórmula:
Calorias do alimento = (Energia por 100g da Tabela TACO) × (Peso informado / 100)
...
Nutriente = (Valor na Tabela TACO por 100g) × (Peso informado / 100)
...
Semanas para meta = |Peso atual - Meta| / (Variação em 30 dias / 4.3)
...
Carnes processadas (salsicha, presunto, bacon, salame, mortadela), Bebidas alcoólicas
...
Cálculo TMB = Harris-Benedict (1919) - Harris JA, Benedict FG
Cálculo GET = TMB × Fator Atividade - WHO/FAO/UNU (1985)
% Gordura (IMC) = Deurenberg - Deurenberg P, et al. (1991)
% Gordura (Dobras) = Jackson & Pollock - Jackson AS, Pollock ML (1978)
Densidade → % Gordura = Siri - Siri WE (1961)
Classificação % Gordura = ACSM - American College of Sports Medicine
Classificação IMC = OMS - World Health Organization
...
Código fonte disponível em: https://github.com/adilsonximenes/biogestao-360
